...
function Sidebar({ onClose }) {
  ...
  return (
    <aside style={{
      ...
      {/* Logo */}
      <div style={{ padding: '1.25rem 1.25rem 1rem', borderBottom: '1px solid rgba(99, 102, 241,0.1)' }}>
        <div style={{ display:'flex', alignItems:'center', gap:'0.625rem' }}>
          <div style={{
            width:36, height:36, borderRadius:14, display:'flex', alignItems:'center', justifyContent:'center',
            background:'linear-gradient(135deg,#3730A3,#4F46E5)', boxShadow:'0 4px 12px rgba(79, 70, 229,0.3)'
          }}>
            <Shield size={18} color="#fff" />
          </div>
          <div>
            <p className="text-gradient" style={{ fontFamily:'Sora,sans-serif', fontWeight:700, fontSize:'0.9375rem' }}>Globetrotter</p>
      ...
      <div style={{ padding:'0.75rem' }}>
        <a href="http://localhost:5173" target="_blank" rel="noreferrer"
          className="nav-link" style={{ width:'100%', color:'#4F46E5', background:'rgba(79, 70, 229,0.04)', border:'1px solid rgba(79, 70, 229,0.15)', marginBottom:'0.5rem', textDecoration:'none' }}>
        ...
        <div style={{
          ...
          background:'rgba(79, 70, 229,0.07)', border:'1px solid rgba(99, 102, 241,0.18)'
        }}>
          <div style={{
          ...
          <div style={{ minWidth:0 }}>
            ...
            <p style={{ fontSize:'0.625rem', color:'#4F46E5', fontWeight:700, textTransform:'uppercase', letterSpacing:'0.06em' }}>Administrator</p>
          </div>
        </div>
      </div>
    </aside>
...
export default function AdminLayout() {
  ...
  return (
    <div style={{ display:'flex', height:'100vh', overflow:'hidden', background:'#F5F5FC' }}>
      {/* Desktop sidebar */}
      ...
      <div style={{ flex:1, display:'flex', flexDirection:'column', minWidth:0, overflow:'hidden' }}>
        ...
        <header style={{
          ...
          background:'rgba(245, 245, 252,0.92)', backdropFilter:'blur(20px)',
          WebkitBackdropFilter:'blur(20px)', borderBottom:'1px solid rgba(99, 102, 241,0.1)',
          ...
          <div style={{ marginLeft:'auto', display:'flex', alignItems:'center', gap:'0.5rem' }}>
            ...
            <button className="btn-icon" style={{ position:'relative' }}>
              <Bell size={16} />
              <span style={{ position:'absolute', top:6, right:6, width:7, height:7, borderRadius:'50%', background:'#4F46E5', border:'2px solid #F5F5FC' }} />
            </button>
          </div>
        </header>
