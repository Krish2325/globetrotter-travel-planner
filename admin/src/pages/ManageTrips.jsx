                ...
                <tbody>
                  {filtered.map((t,i)=>(
                    <tr key={t.id}>
                      ...
                      <td style={{fontWeight:700,color:"#F2683A"}}>{t.basePrice?"Rs. "+t.basePrice.toLocaleString():"-"}</td>
        ...
        {modal&&(
          <motion.div initial={{opacity:0}} animate={{opacity:1}} exit={{opacity:0}}
            ...
            <motion.div initial={{scale:0.95,y:16}} animate={{scale:1,y:0}} exit={{scale:0.95,y:16}}
              ...
              <div style={{padding:"1rem 1.5rem",borderTop:"1px solid rgba(214,122,74,0.15)",display:"flex",justifyContent:"flex-end",gap:"0.75rem"}}>
