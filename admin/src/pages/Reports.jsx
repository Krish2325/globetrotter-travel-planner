...
const REPORTS=[
  {id:1,title:"Monthly Travel Trends",desc:"Trips created, cities searched, activity bookings breakdown",icon:BarChart3,color:"#4F46E5",period:"May 2024",size:"2.4 MB"},
  ...
  return(
    <div style={{display:"flex",flexDirection:"column",gap:"1.5rem"}}>
      ...
      <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fill,minmax(320px,1fr))",gap:"1.25rem"}}>
        {REPORTS.map((r,i)=>(
          <motion.div key={r.id} style={card} initial={{opacity:0,y:20}} animate={{opacity:1,y:0}} transition={{delay:i*0.07}} whileHover={{y:-4,boxShadow:"0 16px 48px rgba(79, 70, 229,0.1)"}}>
