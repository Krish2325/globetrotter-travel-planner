...
import { Shield, Mail, Lock, User, Eye, EyeOff, Loader2, BarChart3, Map, Users, CheckCircle2, KeyRound } from 'lucide-react';
...
export default function AdminSignup() {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      await adminSignup(form.name, form.email, form.password, form.inviteCode);
      setSuccess(true);
      ...
      <div className="hidden lg:flex lg:w-5/12 relative overflow-hidden flex-col items-center justify-center p-14"
        ...
        <motion.div className="relative text-white text-center"
          ...
          <p className="text-white/60 text-sm max-w-xs mx-auto leading-relaxed mb-8">
            Create your administrator account to manage the Globetrotter platform.
          </p>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <div className="relative">
                    <KeyRound className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4" style={{ color:'#9CA3AF' }} />
                    <input id="admin-signup-invite" type="text" placeholder="Provided by an existing administrator"
                      className="input pl-11" value={form.inviteCode} onChange={update('inviteCode')} required />
                  </div>
                  <p className="text-xs mt-1" style={{ color:'#9CA3AF' }}>Admin registration is invite-only for security.</p>
                </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input id="admin-signup-email" type="email" placeholder="admin@globetrotter.dev"
